...
public class RobotContainer {
  ...
  private final ArcadeDrive arcadeDrive = new ArcadeDrive(m_romiDrivetrain, () -> driveController.getLeftY(), () -> driveController.getLeftX());
  ...
  private void setDefaultCommands() {
    m_romiDrivetrain.setDefaultCommand(arcadeDrive);
  }
